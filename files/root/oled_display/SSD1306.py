...
class SSD1306Base(object):
    ...
    def __init__(self, width, height, i2c_address=SSD1306_I2C_ADDRESS):
        self._log = logging.getLogger('KenhTayMay_SSD1306.SSD1306Base')
        self.width = width
        self.height = height
        ...
        self._i2c = I2C.Device(address=i2c_address, busnum=0)
...
class SSD1306_128_32(SSD1306Base):
    def __init__(self, i2c_address=SSD1306_I2C_ADDRESS):
        # Call base class constructor.
        super(SSD1306_128_64, self).__init__(128, 32, i2c_address)
...
class SSD1306_96_16(SSD1306Base):
    def __init__(self, i2c_address=SSD1306_I2C_ADDRESS):
        # Call base class constructor.
        super(SSD1306_128_64, self).__init__(96, 16, i2c_address)
